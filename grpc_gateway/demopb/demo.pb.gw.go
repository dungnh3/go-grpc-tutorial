...
/*
Package demo_pb is a reverse proxy.
...
func RegisterMessageServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server MessageServiceServer) error {
	...
	mux.Handle("POST", pattern_MessageService_Echo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_MessageService_Echo_0(rctx, inboundMarshaler, server, req, pathParams)
...
var (
	pattern_MessageService_Echo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "example", "echo"}, "", runtime.AssumeColonVerbOpt(true)))
)
