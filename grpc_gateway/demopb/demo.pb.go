...
var file_demopb_demo_proto_rawDesc = []byte{
	...
	0x67, 0x32, 0x6d, 0x0a, 0x0e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x53, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x12, 0x5b, 0x0a, 0x04, 0x45, 0x63, 0x68, 0x6f, 0x12, 0x1a, 0x2e, 0x64, 0x65,
	0x6d, 0x6f, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e,
	0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x1a, 0x1a, 0x2e, 0x64, 0x65, 0x6d, 0x6f, 0x2e, 0x67,
	0x72, 0x70, 0x63, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x4d, 0x65, 0x73, 0x73,
	...
	0x42, 0x09, 0x5a, 0x07, 0x64, 0x65, 0x6d, 0x6f, 0x2e, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_demopb_demo_proto_goTypes = []interface{}{
	(*Message)(nil), // 0: demo.grpc.gateway.Message
}
var file_demopb_demo_proto_depIdxs = []int32{
	0, // 0: demo.grpc.gateway.MessageService.Echo:input_type -> demo.grpc.gateway.Message
	0, // 1: demo.grpc.gateway.MessageService.Echo:output_type -> demo.grpc.gateway.Message
...
func (c *messageServiceClient) Echo(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
...
func (*UnimplementedMessageServiceServer) Echo(context.Context, *Message) (*Message, error) {
...
func _MessageService_Echo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MessageServiceServer).Echo(ctx, req.(*Message))
	}
