...
func (x *MessageRequest) GetNumber() int32 {
	if x != nil {
		return x.Number
	}
	return 0
...
var file_demopb_demo_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x11, 0x64, 0x65, 0x6d, 0x6f, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x67,
	...
	,
	...
	0x63, 0x68, 0x6f, 0x3a, 0x01, 0x2a, 0x42, 0x09, 0x5a, 0x07, 0x64, 0x65, 0x6d, 0x6f, 0x2e, 0x70,
...
var file_demopb_demo_proto_goTypes = []interface{}{
	(*MessageRequest)(nil),  // 0: demo.grpc.gateway.MessageRequest
	(*MessageResponse)(nil), // 1: demo.grpc.gateway.MessageResponse
}
var file_demopb_demo_proto_depIdxs = []int32{
	0, // 0: demo.grpc.gateway.MessageService.Echo:input_type -> demo.grpc.gateway.MessageRequest
	1, // 1: demo.grpc.gateway.MessageService.Echo:output_type -> demo.grpc.gateway.MessageResponse
...
func (c *messageServiceClient) Echo(ctx context.Context, in *MessageRequest, opts ...grpc.CallOption) (*MessageResponse, error) {
	out := new(MessageResponse)
	err := c.cc.Invoke(ctx, "/demo.grpc.gateway.MessageService/Echo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedMessageServiceServer) Echo(context.Context, *MessageRequest) (*MessageResponse, error) {
...
func _MessageService_Echo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/demo.grpc.gateway.MessageService/Echo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MessageServiceServer).Echo(ctx, req.(*MessageRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _MessageService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "demo.grpc.gateway.MessageService",
